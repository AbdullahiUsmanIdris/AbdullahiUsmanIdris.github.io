...
* Led mechanical CAD design and FDM prototyping of 2 hull components, an electronics enclosure, and wings for the USV
* Co-developed a successful funding proposal that secured ₺50,000 in Teknofest project funding for prototype fabrication, materials, and integration

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; margin: 1.5em 0;">
  <iframe src="https://www.youtube.com/embed/1cou7OcQDk4" title="TEKNOFEST Unmanned Surface Vehicle" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
</div>
